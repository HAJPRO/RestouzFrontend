        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="p-6 bg-white dark:bg-slate-900 rounded-[32px] border border-slate-100 dark:border-white/5 shadow-sm relative overflow-hidden">
            <div class="relative z-10">
              ...
              <h3 class="text-2xl font-black text-slate-900 dark:text-white mt-1">128 <span class="text-[10px] text-emerald-500 font-black">+12%</span></h3>
            </div>
          </div>
          ...
          <div class="p-6 bg-white dark:bg-slate-900 rounded-[32px] border border-slate-100 dark:border-white/5 shadow-sm relative overflow-hidden">
            <div class="relative z-10">
              ...
              <h3 class="text-2xl font-black text-slate-900 dark:text-white mt-1">14 <span class="text-[10px] text-amber-500 font-black">Faol</span></h3>
            </div>
          </div>
        </div>
...
// Statik ma'lumotlar
const topStaff = ref([
  { id: 1, name: "Umid Shomurodov", orders: 42 },
  { id: 2, name: "Abdulaziz Khan", orders: 38 },
  { id: 3, name: "Sardorbek", orders: 25 }
]);

const topDishes = ref([
  { id: 1, name: "Palov (Maxsus)", count: 124, image: "https://picsum.photos/100" },
  { id: 2, name: "Shashlik Mix", count: 98, image: "https://picsum.photos/101" },
  { id: 3, name: "Somsa", count: 86, image: "https://picsum.photos/102" }
]);
